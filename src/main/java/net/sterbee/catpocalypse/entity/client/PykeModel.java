...
public class PykeModel<T extends PykeEntity> extends SinglePartEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData head = pyke.addChild("head", ModelPartBuilder.create().uv(0, 15).cuboid(-3.0F, -14.0F, -1.0F, 4.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 5.0F, -9.8F, 0.0436F, 0.0F, 0.0F));
        ...
        ModelPartData body = pyke.addChild("body", ModelPartBuilder.create().uv(-4, -4).cuboid(-2.75F, -7.25F, -8.0F, 3.5F, 4.0F, 15.0F, new Dilation(0.0F))
                .uv(19, 0).cuboid(-2.9F, -7.5F, 6.0F, 3.8F, 4.5F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData legs = pyke.addChild("legs", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData topright = legs.addChild("topright", ModelPartBuilder.create().uv(20, 21).cuboid(-3.0F, -6.5F, -7.0F, 1.0F, 6.5F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData topleft = legs.addChild("topleft", ModelPartBuilder.create().uv(14, 21).cuboid(0.0F, -6.75F, -7.0F, 1.0F, 6.75F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData bottomleft = legs.addChild("bottomleft", ModelPartBuilder.create().uv(7, 25).cuboid(-0.25F, -4.0F, 6.5F, 1.0F, 4.0F, 1.5F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData bottomright = bottomleft.addChild("bottomright", ModelPartBuilder.create().uv(0, 23).cuboid(-2.75F, -4.0F, 6.5F, 1.0F, 4.0F, 1.5F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData tail = pyke.addChild("tail", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -0.7F, 0.0F));

        ModelPartData fronttail = tail.addChild("fronttail", ModelPartBuilder.create().uv(0, 0).cuboid(-1.5F, -6.5F, 7.7F, 1.0F, 1.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData backtail = tail.addChild("backtail", ModelPartBuilder.create().uv(16, 15).cuboid(-1.6F, -6.6F, 10.2F, 1.2F, 1.2F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 1.2F));
